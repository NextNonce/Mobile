...
const val KAMEL_CACHE_SIZE_MULTIPLIER = 30

const val MAX_CACHED_BALANCES_REQUESTS = 4

const val BASE_CACHED_REQUEST_DELAY = 4_000L // 4 seconds

const val MAX_CACHED_BALANCES_DELAY = 60_000L

const val BASE_REFRESH_DELAY = 60_000L // 60 seconds